...
@WebServlet(Endpoints.SEGUIR_USUARIO_SERVLET)
public class SeguirUsuario extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            controladorUsuario.relacionSeguirUsuario(nickSeguido, nickSeguidor);
            ...
            System.out.println("Error al seguir usuario: " + e.getMessage());
            return;
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("usuario") == null) {
            ...
            response.getWriter().write("{\"error\": \"No se ha especificado el nombre del usuario a seguir\"}");
            return;
        }

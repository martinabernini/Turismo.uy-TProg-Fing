							...
							<div id="collapse-A" class="collapse show"
								...
								<div class="card-body">
									...
									<div class="d-flex mb-0">
										<p class="text-dark font-weight-medium mb-0 mr-3">Nombre
											de la salida:</p>
									...
									<div class="d-flex mb-0">
										<p class="text-dark font-weight-medium mb-0 mr-3">Cantidad
											maxima de inscriptos:</p>
										<p class="mb-4">${param.cantInscriptos}</p>
									</div>

                        ...
                        <div class="social-login">
                            <div class="text-center mt-4">
									<span class="ml-auto"><a
                                            href="<%= Endpoints.ALTA_TURISTA %>"
                                            class="btn btn-block btn-primary">Registrar turista</a></span> <span
                                    class="ml-auto"><a href="<%= Endpoints.ALTA_PROVEEDOR %>"
                                                       class="btn btn-block btn-primary">Registrar proveedor</a></span>
                            </div>
                        </div>
                    </form>
                </div>
